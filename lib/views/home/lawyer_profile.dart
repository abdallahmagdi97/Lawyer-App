...
import 'package:lawyerApp/views/home/add_request.dart';
      ...
      appBar: AppBar(
        actions: <Widget>[
          FlatButton.icon(
              ...
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => /*AddRequest()*/null)),
            ),
          FlatButton.icon(
              icon: Icon(Icons.arrow_back),
              label: Text('Back To Lawyers List'),
